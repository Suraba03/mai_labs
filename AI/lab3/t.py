...
# from readVesselMesh import read_vessel_mesh, proj_solu_from_ofmesh_2_mymesh
...
Itol=0
#Prepare data
mesh_hf,nx_hf,ny_hf=read_vessel_mesh('/content/drive/MyDrive/ns_eqn_parabolic/3200/C')
solu_hf1=convertOFMeshToImage_StructuredMesh(nx_hf,ny_hf,'/content/drive/MyDrive/ns_eqn_parabolic/3200/C',
	                                             ['/content/drive/MyDrive/ns_eqn_parabolic/3200/U',
	                                              '/content/drive/MyDrive/ns_eqn_parabolic/3200/p'],
	                                            [0,1,0,1],0.0,False)
solu_hf2=convertOFMeshToImage_StructuredMesh(nx_hf,ny_hf,'/content/drive/MyDrive/ns_eqn_parabolic/3200/C',
	                                             ['/content/drive/MyDrive/ns_eqn_parabolic/3200/T'],
	                                            [0,1,0,1],0.0,False)
solu_hf=np.concatenate([solu_hf1,solu_hf2[:,:,2:]],axis=2)
mesh_lf,nx_lf,ny_lf=read_vessel_mesh('/content/drive/MyDrive/Coarse/3200/C')
solu_lf=convertOFMeshToImage_StructuredMesh(nx_lf,ny_lf,'/content/drive/MyDrive/Coarse/3200/C',
	                                           ['/content/drive/MyDrive/Coarse/3200/U',
	                                            '/content/drive/MyDrive/Coarse/3200/p'], 
												[0,1,0,1],1,False)
